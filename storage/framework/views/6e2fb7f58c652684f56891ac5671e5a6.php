<?php $__env->startSection('title', 'Konversi Poin Sukses'); ?>
    
<?php $__env->startSection('content'); ?>
    <div class="p-3 my-4">
        <h3 class="fw-bold mb-5 text-center">Konversi Poin Berhasil</h3>
        <div class="text-center mb-5">
            <img src="<?php echo e(asset('images/success-convert.svg')); ?>">
        </div>
        ...
        <div class="text-center">
            <a href="<?php echo e(Route('user.dashboard-user')); ?>" class="btn btn-secondary rounded px-3 me-md-2 me-0 d-md-inline d-block">Kembali ke dashboard</a>
            <button class="btn btn-green rounded px-3 mt-md-0 mt-2 button-full" onclick="window.print()">Cetak detail konversi</button>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NoxxalsGod\Documents\Pemograman Website\pengelolaan-sampah-menumpuk\resources\views/penukaran/sukses_konversi_poin.blade.php ENDPATH**/ ?>