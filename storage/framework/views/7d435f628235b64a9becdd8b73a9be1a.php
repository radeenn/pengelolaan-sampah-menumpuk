...
<?php $__env->startSection('content'); ?>
    ...
    <section id="main-view" class="py-5 mb-4">
        <div class="row justify-content-between">
            <div class="col-lg-6 col-12 mt-lg-3 mt-0">
                ...
                <a href="<?php echo e(Route('penukaran-sampah')); ?>" class="btn btn-green py-2 px-4 mb-lg-0 mb-5 rounded">
                    <span class="align-middle fw-bold">Tukar Sampah</span>
                    <span class="fa fa-arrow-right ms-2 align-middle" aria-hidden="true"></span>
                </a>
            </div>
            <div class="col-lg-6">
                <img src="<?php echo e(asset('images/home-illustration.svg')); ?>" alt="home-illustration" class="w-100">
            </div>
        </div>
    </section>
    ...
    <section id="stat-view" class="py-4 mb-4">
        ...
        <div class="row align-items-center text-center">
            ...
            <div class="col-md-3 col-6 mb-md-0 mb-3">
                <h2 class="fw-bold text-green"><?php echo e($count_products); ?></h2>
                <p>Produk pemilahan</p>
            </div>
            <div class="col-md-3 col-6">
                <h2 class="fw-bold text-green"><?php echo e($count_wastes); ?> kg</h2>
                <p>Sampah ditukar</p>
            </div>
            <div class="col-md-3 col-6">
                <h2 class="fw-bold text-green"><?php echo e($count_users); ?>+</h2>
                <p>Pengguna aktif</p>
            </div>
        </div>
    </section>
    ...
    <section id="blog-view" class="py-lg-5 py-4 mb-4">
        ...
        <tr>
            <div class="row justify-content-center">
                <?php $__currentLoopData = $show_blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-6 col-12 mb-lg-0 mb-4">
                    <div class="card h-100">
                        <img src="/blogs/<?php echo e($blog->image); ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h6 class="card-title fw-bold"><?php echo e($blog->judul); ?></h6>
                            <p class="card-text opacity-50"><small><?php echo e($blog->created_at); ?></small></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NoxxalsGod\Documents\Pemograman Website\pengelolaan-sampah-menumpuk\resources\views/home.blade.php ENDPATH**/ ?>