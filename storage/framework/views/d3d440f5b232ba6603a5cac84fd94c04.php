<?php $__env->startSection('title', 'Penukaran Sampah'); ?>
...
<?php $__env->startSection('content'); ?>
    <section id="main-view" class="py-5 mb-4">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-6">
                <img src="<?php echo e(asset('images/penukaran-sampah.svg')); ?>" alt="waste-illustration" class="w-100">
            </div>
        </div>
    </section>
    ...
    <section id="flow-view" class="py-4 mb-5">
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-4 col-12 mb-md-0 mb-4">
                <img src="<?php echo e(asset('images/number-four.svg')); ?>" class="mb-3">
            ...
            <div class="col-lg-4 col-12">
                <img src="<?php echo e(asset('images/number-five.svg')); ?>" class="mb-3">
    ...
    <section id="waste-type" class="py-4 mb-5">
        ...
        <div class="row justify-content-center text-center w-100">
            <div class="col-xl-3 col-lg-4 col-md-5 col-12 mb-xl-0 mb-4">
                <img src="<?php echo e(asset('images/waste-kertas.svg')); ?>" class="rounded shadow-sm">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-12 mb-xl-0 mb-4">
                <img src="<?php echo e(asset('images/waste-plastik.svg')); ?>" class="rounded shadow-sm">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-12 mb-xl-0 mb-4">
                <img src="<?php echo e(asset('images/waste-metal.svg')); ?>" class="rounded shadow-sm">
            </div>
            <div class="col-xl-3 col-lg-4 col-md-5 col-12 mb-xl-0 mb-4">
                <img src="<?php echo e(asset('images/waste-jelantah.svg')); ?>" class="rounded shadow-sm">
            </div>
        </div>
    </section>
    ...
    <?php if(auth()->guard()->guest()): ?>
        <div id="input-data" class="pt-5 mb-2 text-center">
            <a href="<?php echo e(route('login')); ?>" class="btn btn-green w-20 py-2 px-4 fw-bold rounded mt-5">Login untuk penukaran sampah</a>
        </div>
    <?php else: ?>
        <section id="input-data" class="pt-5 pb-4 mb-2">
            <div class="mb-5 pt-5">
                ...
                <?php if(session('exchange-success')): ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <div class="container">
                            <?php echo e(session('exchange-success')); ?>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-5 col-12">
                    <form action="<?php echo e(Route('penukaran-sampah')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                            <label for="weight" class="form-label fw-bolder">Berat sampah</label>
                            <div class="input-group">
                                <input type="number" class="form-control" id="weight" name="weight" value="1" min="1" placeholder="Masukkan berat sampah" value="<?php echo e(old('waste_weight')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="category" name="category" aria-label="Default select example" value="<?php echo e(old('categories')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3" placeholder="Contoh: Jl. Rusa raya No. 71, Kel. Sertajaya, Kec. Cikarang Timur, Kab. Bekasi, Jawa Barat" value="<?php echo e(old('address')); ?>"><?php echo e(Auth::user()->address); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="note" name="note" placeholder="Catatan tambahan, boleh diisi atau engga" value="<?php echo e(old('note')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-6 d-lg-block d-none ps-5">
                    <img src="<?php echo e(asset('images/waste-illustration.svg')); ?>" alt="waste-illustration">
                </div>
            </div>
        </section>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NoxxalsGod\Documents\Pemograman Website\pengelolaan-sampah-menumpuk\resources\views/penukaran/sampah.blade.php ENDPATH**/ ?>